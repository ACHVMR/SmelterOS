...
describe('DigitalBreaker', () => {
  ...
  afterEach(() => {
    // Suppress console.log during cleanup
    console.log = () => {};
    try {
      breaker.masterOff();
    } catch (e) {
  ...
  describe('Master Switch', () => {
    ...
    it('should turn master OFF', () => {
      breaker.masterOff();
      const state = breaker.getState();
      expect(state.masterSwitch.state).toBe('off');
    });

    it('should turn master back ON', () => {
      breaker.masterOff();
      breaker.masterOn();
      const state = breaker.getState();
      expect(state.masterSwitch.state).toBe('on');
    ...
    it('should perform emergency shutdown', () => {
      breaker.emergencyShutdown('test-user', 'Unit test emergency');
      const state = breaker.getState();
      expect(state.masterSwitch.state).toBe('off');
      expect(state.masterSwitch.emergencyShutdown).toBe(true);
    });

    it('should track power cycles', () => {
  ...
  describe('Audit Trail', () => {
    it('should log master switch operations', () => {
      breaker.masterOff();
      breaker.masterOn();
